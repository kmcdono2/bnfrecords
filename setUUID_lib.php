...
/////////////////////////////////////////////////////////// Get and Set Vars
	...
	$query = "TRUNCATE Libraire_XML_UUID;";
...
/////////////////////////////////////////////////////////// Run Routines
	...
	for($b=0; $b<12; $b++){
		...
		$url = "http://catalogue.bnf.fr/api/SRU?version=1.2&operation=searchRetrieve&query=(aut.type%20all%20%22pep%22)%20and%20(aut.anywhere%20all%20%22libraire%22)%20and%20(aut.status=validated)&recordSchema=intermarcxchange&maximumRecords=1000&startRecord=$a";
		...
		for($X=0; $X<1000; $X++) { 
			...
			$UUID = guidv4();
			$query = "INSERT INTO Libraire_XML_UUID ";
